  ...
  return (
    <footer className="bg-black border-t border-white/10">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:pt-16">
        ...
        <div className="mt-6 sm:mt-8 text-center text-[10px] sm:text-xs text-slate-400 lg:text-right">
          <p>SEC-Registered Investment Advisor | CRD #338073</p>
          <p className="mt-1">Copyright &copy; {new Date().getFullYear()} Clera. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
